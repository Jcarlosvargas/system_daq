...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Testers" Type="Folder">
			...
			<Item Name="Test UI User API.vi" Type="VI" URL="../Libraries/UI User/Test UI User API.vi"/>
			<Item Name="Test Hardware DAQ API.vi" Type="VI" URL="../Libraries/Hardware DAQ/Test Hardware DAQ API.vi"/>
			<Item Name="Test Client HTTP Post API.vi" Type="VI" URL="../Libraries/Client HTTP Post/Test Client HTTP Post API.vi"/>
			<Item Name="Test Client HTTP Get API.vi" Type="VI" URL="../Libraries/Client HTTP Get/Test Client HTTP Get API.vi"/>
		</Item>
		<Item Name="Modules" Type="Folder">
			...
			<Item Name="UI User.lvlib" Type="Library" URL="../Libraries/UI User/UI User.lvlib"/>
			<Item Name="Hardware DAQ.lvlib" Type="Library" URL="../Libraries/Hardware DAQ/Hardware DAQ.lvlib"/>
			<Item Name="Client HTTP Post.lvlib" Type="Library" URL="../Libraries/Client HTTP Post/Client HTTP Post.lvlib"/>
			<Item Name="Client HTTP Get.lvlib" Type="Library" URL="../Libraries/Client HTTP Get/Client HTTP Get.lvlib"/>
		</Item>
		<Item Name="Configuration" Type="Folder">
			<Item Name="Configuracion de Inicio DAQ.ini" Type="Document" URL="../Configuration/Configuracion de Inicio DAQ.ini"/>
		</Item>
